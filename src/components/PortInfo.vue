<template>
  <div class="layout">
    <div class="banner">
      <img class="logo-cut" :src="logoCut" alt=""/>
    ...
    <div class="performance">
      <div class="card1">
        <SimpleDescribe :performance="performance1" :id="1" v-if="netValueDataOk"/>
      </div>
      <div class="card2">
        <SimpleDescribe :performance="performance2" :id="2" @selectDate="changeDate" v-if="netValueDataOk"/>
      </div>
    </div>
    ...
    <div class="detail">
      ...
      <div class="operations">
        ...
        <p class="note">注：成立以来总收益已扣除资管计划层面费用，与单支基金损益之和可能存在差异。</p>
      </div>
    </div>
    <p class="disclaimer">
